...
export default function OnlineLMSLanding() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#FFF7DF] text-[#18191E] overflow-x-hidden font-sans selection:bg-[#18191E] selection:text-white">
      {/* ========================================================================= */}
      {/* 1. ORGANIC CORNER DECORATIVE ACCENTS                                     */}
      {/* ========================================================================= */}
      ...
      {/* Bottom Right Organic Dark Shape */}
      <div
      ...
      {/* ========================================================================= */}
      {/* 2. OCHRE / GOLD DOT GRID MATRICES                                        */}
      {/* ========================================================================= */}
      {/* Top Right Dot Grid */}
      <div
      ...
      {/* Mid Left Dot Grid */}
      <div
        className="pointer-events-none absolute top-[52%] left-6 sm:left-12 md:left-20 z-0 grid grid-cols-5 gap-2.5 sm:gap-3.5 opacity-65"
        aria-hidden="true"
      >
        {Array.from({ length: 20 }).map((_, i) => (
          <div
      ...
      <header className="relative z-20 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-6 sm:pt-8 flex items-center justify-between">
        ...
        >
          ...
          <span className="font-bold text-xl sm:text-2xl tracking-tight text-[#18191E]">
            Online<span className="font-extrabold">LMS</span>
          </span>
        </Link>
      ...
      {/* 4. HERO SECTION                                                          */}
      {/* ========================================================================= */}
      <main className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-8 sm:pt-14 pb-8">
        ...
        {/* ========================================================================= */}
        {/* 5. FLOATING STATS BANNER                                                 */}
        {/* ========================================================================= */}
        <div className="relative z-20 mt-12 sm:mt-16 w-full">
          <div className="w-full max-w-6xl mx-auto rounded-3xl bg-white/80 backdrop-blur-xl border border-white/90 shadow-xl shadow-amber-950/5 px-6 sm:px-12 py-7 sm:py-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 divide-y lg:divide-y-0 lg:divide-x divide-neutral-200/60">
              ...
              <div className="flex items-center gap-4 pt-4 first:pt-0 lg:pt-0 lg:px-4 first:pl-0">
                <div className="w-12 h-12 rounded-2xl bg-amber-50 border border-amber-200/50 flex items-center justify-center text-[#18191E] shrink-0 shadow-sm">
        ...
        {/* ========================================================================= */}
        <section className="relative z-10 mt-16 sm:mt-24 pt-8 pb-16">
          {/* Header Row */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-300/40 pb-6 mb-10">
        ...
        {/* ========================================================================= */}
        {/* 7. BONUS: COURSE PREVIEWS SECTION (Clean, non-intrusive)                  */}
        {/* ========================================================================= */}
        <section id="courses-section" className="relative z-10 pt-12 pb-20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/70 backdrop-blur-md border border-[#CBB78B]/40 text-xs font-semibold text-[#18191E] mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Course Card 1 */}
            <div className="p-6 rounded-3xl bg-white/70 backdrop-blur-md border border-white/80 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              <div>
      ...
      {/* 8. FOOTER                                                                 */}
      {/* ========================================================================= */}
      <footer className="relative z-10 border-t border-neutral-300/40 bg-white/40 backdrop-blur-md py-8">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#7A776D]">
          <div className="flex items-center gap-2">
            <span className="font-bold text-[#18191E]">OnlineLMS</span>
            <span>•</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="#contact" className="hover:text-[#18191E] transition-colors">
              Contact Support
            </Link>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 border-b border-neutral-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold">OnlineLMS Interactive Demo</h3>
              </div>
              <button
                onClick={() => setIsVideoModalOpen(false)}
