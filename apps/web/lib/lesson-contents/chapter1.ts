        ...
        items: [
          {
            term: "W = [V]",
            pronunciation: "veh",
            meaning: "Pronounced like English 'V'",
            example: "das Wasser (water) sounds like 'Vasser', Wien (Vienna) sounds like 'Veen'.",
          },
          {
            term: "V = [F]",
            pronunciation: "fau",
            meaning: "Pronounced like English 'F' in native words",
            example: "der Vater (father) sounds like 'Fah-ter', vier (four) sounds like 'feer'.",
          },
          {
            term: "J = [Y]",
            pronunciation: "yott",
            meaning: "Pronounced like English 'Y'",
            example: "ja (yes) sounds like 'yah', das Jahr (year) sounds like 'yahr'.",
          },
          {
            term: "Z = [TS]",
            pronunciation: "tsett",
            meaning: "Pronounced like sharp 'ts'",
            example: "die Zeit (time) sounds like 'Tsayt', zehn (ten) sounds like 'tsehn'.",
          },
        ],
      },
    ],
